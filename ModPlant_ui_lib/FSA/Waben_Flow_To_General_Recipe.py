...
def save_general_recipe_xml(schedule: List[Dict], order: Dict, out_dir: str | None = None) -> str:
    """
    Save pretty-printed General Recipe XML.

    Args:
        schedule: Generated schedule rows.
        order: Order dict.
        out_dir: Optional target directory. If None, defaults to <script_dir>/Recipe/XML.
    """
